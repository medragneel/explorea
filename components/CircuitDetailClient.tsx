...
import {
    ...
    Mountain, Sun, Moon, ArrowRight, Play,
} from 'lucide-react'
...
// ── Difficulty mapping ────────────────────────────────────────────────────
function getDifficulty(duree: number) {
...
export default function CircuitDetailClient({
    ...
    const difficulty = getDifficulty(circuit.duree)
    const firstAvailable = departs.find(d => d.placesRestantes > 0)

    // Sync timeline with map
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-center gap-4 mt-6">
                            {[
                                { icon: Clock, value: `${circuit.duree} jours`, label: 'Durée' },
                                { icon: MapPin, value: circuit.region, label: 'Région' },
                                { icon: Users, value: `Max ${departs[0]?.placesMax ?? 12}`, label: 'Personnes' },
                                { icon: Banknote, value: `${circuit.prix?.toLocaleString('fr-DZ')} DZD`, label: 'Par personne' },
                            ].map(stat => (
                                <div key={stat.label} className="flex items-center gap-2 bg-black/30 backdrop-blur-sm border border-white/10 px-3 py-2">
                                    <stat.icon className="h-3.5 w-3.5 text-[#B8962E]" />
                                    <div>
                                        <div className="text-white text-xs font-light">{stat.value}</div>
                                        <div className="text-white/40 text-[9px] font-mono">{stat.label}</div>
                                    </div>
                                </div>
                            ))}
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {highlights.map((h, i) => (
                                    <motion.div
                                        ...
                                        className="bg-white border border-[#1B2D5B]/08 p-5 group hover:border-[#B8962E]/30 transition-colors"
                                    >
                                    ...
                                    {itinerary.map((day, i) => (
                                        ...
                                        >
                                            ...
                                            <div className="relative pl-16">
                                                ...
                                                {/* Card */}
                                                <div
                                                    className={`bg-white border transition-all duration-300 overflow-hidden ${activeDay === day.day
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-4">
                                                            <div>
                                                                ...
                                                                <h3
                                                                    className="text-base font-light text-[#1B2D5B]"
                                                                    style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                                                                >
                                                                    {day.title}
                                                                </h3>
                                                        ...
                                                        <div className="flex items-center gap-3 flex-shrink-0">
                                                            <div className="flex items-center gap-1 text-[#1B2D5B]/40 text-[10px] font-mono">
                                    ...
                                    <div className="mt-5 pt-5 border-t border-[#1B2D5B]/06">
                                        <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 p-3">
                                            ...
                                            <p className="text-xs text-amber-700 leading-relaxed">
                                                <strong>Paiement en espèces uniquement.</strong> Notre équipe vous contactera pour confirmer et organiser le paiement.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-end justify-between mb-4">
                                    <div>
                                        ...
                                        >
                                            ...
                                            <span className="text-sm font-mono text-white/30 ml-1">DZD</span>
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        {departs.map(depart => {
                                            ...
                                            return (
                                                <div
                                                    key={depart.id}
                                                    className={`p-3 border transition-colors ${isFull
                                                            ? 'border-[#1B2D5B]/06 opacity-50'
                                                            : 'border-[#1B2D5B]/10 hover:border-[#B8962E]/30 cursor-pointer'
                                                        }`}
                                                >
