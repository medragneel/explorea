...
export default function HeroSection() {
    ...
    // ✅ Nested namespace — matches home.hero.* in messages files
    ...
    useEffect(() => {
        ...
        if (!v) return
        const onProgress = () => setVideoProgress((v.currentTime / v.duration) * 100 || 0)
    ...
    return (
        <LazyMotion features={domAnimation} strict>
            <section ref={heroRef} className="relative h-screen overflow-hidden">
                ...
                {/* ── POSTER — shows instantly before video loads ──────── */}
                <div className="absolute inset-0 z-0 bg-[#080604]">
                    <img
                        src="/hero-poster.jpg"
                        alt=""
                        aria-hidden="true"
                ...
                {/* ── VIDEO ────────────────────────────────────────────── */}
                <m.div className="absolute inset-0 z-0" style={{ y: videoY, scale: videoScale }}>
                    <video
                        ref={videoRef}
                ...
                >
                    <m.div initial="hidden" animate="visible" variants={stagger}>
                        ...
                        <m.h1
                            variants={fadeUp}
                            custom={1}
                            className="text-5xl md:text-7xl lg:text-8xl font-light leading-[0.9] tracking-tight mb-6 text-white"
                            style={{ fontFamily: "'Playfair Display', Georgia, serif" }}
                        >
                            {t('title_line1')}
                            <br />
                            <em className="text-amber-300 not-italic">{t('title_line2')}</em>
                        </m.h1>
                        ...
                        {/* CTAs */}
                        <m.div variants={fadeUp} custom={3} className="flex flex-wrap gap-4 items-center">
                            <Link
                                href="/circuits"
                ...
                >
                    <div
                        className="w-48 h-px bg-white/20 cursor-pointer relative"
                        onClick={seekVideo}
                    >
                        <div
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        >
                            ...
                            <span className="font-mono">{playing ? t('pause') : t('play')}</span>
                        </button>
